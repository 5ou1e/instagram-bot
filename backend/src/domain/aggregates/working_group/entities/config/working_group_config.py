...
from src.domain.aggregates.working_group.entities.config.flows_config import (
    WorkingGroupFlowsConfig,
)
from src.domain.aggregates.working_group.entities.config.general_config import (
    WorkingGroupGeneralConfig,
)
from src.domain.aggregates.working_group.entities.config.logging_config import (
    WorkingGroupLoggingConfig,
)
from src.domain.aggregates.working_group.entities.config.network_config import (
