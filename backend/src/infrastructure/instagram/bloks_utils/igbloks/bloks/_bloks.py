from typing import Any, ForwardRef, Self, get_type_hints
...
class BkTypesThemedcolor(Branch):
    aliases: dict[str, str] = {
        "c48de7e714bc4ad7ea5c9b1f004e5b0a40f24369494f20c705bd9c27451a0604": "㐵",
        "456a06cb008a2f6d72f04e94d26242d4607e80d5cf8d9a5aa34ec109117071c6": "bk.types.ThemedColor",
    }
    light_color: str = BlokField(
        aliases={
            "c48de7e714bc4ad7ea5c9b1f004e5b0a40f24369494f20c705bd9c27451a0604": "$",
            "456a06cb008a2f6d72f04e94d26242d4607e80d5cf8d9a5aa34ec109117071c6": "light_color",
        }
    )
    dark_color: str = BlokField(
        aliases={
            "c48de7e714bc4ad7ea5c9b1f004e5b0a40f24369494f20c705bd9c27451a0604": "#",
...
class Flex(Branch):
    ...
    padding_start: str = BlokField(
        aliases={
            "c48de7e714bc4ad7ea5c9b1f004e5b0a40f24369494f20c705bd9c27451a0604": ";",
            "456a06cb008a2f6d72f04e94d26242d4607e80d5cf8d9a5aa34ec109117071c6": "padding_start",
        }
    )
    padding_end: str = BlokField(
        aliases={
            "c48de7e714bc4ad7ea5c9b1f004e5b0a40f24369494f20c705bd9c27451a0604": "8",
            "456a06cb008a2f6d72f04e94d26242d4607e80d5cf8d9a5aa34ec109117071c6": "padding_end",
        }
    )
    shrink: int = BlokField(
        aliases={
            "c48de7e714bc4ad7ea5c9b1f004e5b0a40f24369494f20c705bd9c27451a0604": "A",
...
class BkComponentsVisibilityextension(Branch):
    aliases: dict[str, str] = {
        "c48de7e714bc4ad7ea5c9b1f004e5b0a40f24369494f20c705bd9c27451a0604": "㓢",
...
class BkComponentsTextspan(Branch):
    aliases: dict[str, str] = {
        "c48de7e714bc4ad7ea5c9b1f004e5b0a40f24369494f20c705bd9c27451a0604": "㐛",
...
class IgComponentsIcon(Branch):
    aliases: dict[str, str] = {
        "c48de7e714bc4ad7ea5c9b1f004e5b0a40f24369494f20c705bd9c27451a0604": "㑄",
    ...
    tint_themed_color: BkTypesThemedcolor | str = BlokField(
        aliases={
            "c48de7e714bc4ad7ea5c9b1f004e5b0a40f24369494f20c705bd9c27451a0604": "(",
...
class BkComponentsImage(Branch):
    aliases: dict[str, str] = {
        "c48de7e714bc4ad7ea5c9b1f004e5b0a40f24369494f20c705bd9c27451a0604": "㐋",
...
class BkComponentsRichtext(Branch):
    aliases: dict[str, str] = {
        "c48de7e714bc4ad7ea5c9b1f004e5b0a40f24369494f20c705bd9c27451a0604": "㐑",
        "456a06cb008a2f6d72f04e94d26242d4607e80d5cf8d9a5aa34ec109117071c6": "bk.components.RichText",
    }
    children: list[str | BkComponentsTextspan] = BlokField(
        aliases={
            "c48de7e714bc4ad7ea5c9b1f004e5b0a40f24369494f20c705bd9c27451a0604": " ",
            "456a06cb008a2f6d72f04e94d26242d4607e80d5cf8d9a5aa34ec109117071c6": "children",
        }
    )
    text_align: str = BlokField(
        aliases={
            "c48de7e714bc4ad7ea5c9b1f004e5b0a40f24369494f20c705bd9c27451a0604": "*",
            "456a06cb008a2f6d72f04e94d26242d4607e80d5cf8d9a5aa34ec109117071c6": "text_align",
        }
    )
    line_height_multiplier: float = BlokField(
        aliases={
            "c48de7e714bc4ad7ea5c9b1f004e5b0a40f24369494f20c705bd9c27451a0604": "&",
...
class BkComponentsText(Branch):
    aliases: dict[str, str] = {
        "c48de7e714bc4ad7ea5c9b1f004e5b0a40f24369494f20c705bd9c27451a0604": "㐗",
    ...
    text_themed_color: BkTypesThemedcolor | str = BlokField(
        aliases={
            "c48de7e714bc4ad7ea5c9b1f004e5b0a40f24369494f20c705bd9c27451a0604": "0",
            "456a06cb008a2f6d72f04e94d26242d4607e80d5cf8d9a5aa34ec109117071c6": "text_themed_color",
        }
    )
...
class BkComponentsFlexbox(Branch):
    aliases: dict[str, str] = {
        "c48de7e714bc4ad7ea5c9b1f004e5b0a40f24369494f20c705bd9c27451a0604": "㐈",
        "456a06cb008a2f6d72f04e94d26242d4607e80d5cf8d9a5aa34ec109117071c6": "bk.components.Flexbox",
    }
    flex_direction: str = BlokField(
        aliases={
            "c48de7e714bc4ad7ea5c9b1f004e5b0a40f24369494f20c705bd9c27451a0604": ")",
    ...
    children: list[
        BkComponentsCollection
        | BkComponentsRichtext
        | Self
        | BkComponentsText
        | IgComponentsIcon
        | str
    ...
    extensions: list[
        str | BkComponentsAutomationtestextension | BkComponentsAccessibilityextension
    ] = BlokField(
        aliases={
            "c48de7e714bc4ad7ea5c9b1f004e5b0a40f24369494f20c705bd9c27451a0604": "",
            "456a06cb008a2f6d72f04e94d26242d4607e80d5cf8d9a5aa34ec109117071c6": "extensions",
...
def __to_py_obj__(content: dict, bkid: str, *args, **kwargs) -> BkComponentsFlexbox:
    if (branch_name := get_branch_name(content)) is not None:
        for branch in [
            BkComponentsFlexbox,
        ]:
            if branch_name == branch.aliases.get(bkid):
                return branch.__to_py_obj__(
                    content=content,
                    bkid=bkid,
                    *args,
                    **kwargs,
